...
public class StatisticsSelector {
  ...
  public enum StatisticsMeasures {
    MIN,
    MAX,
    MEAN,
    MEDIAN,
  ...
  private StatisticsMeasure retrieveMeasure(StatisticsMeasures measure) {
    ...
    switch (measure) {
      case MIN:
        statisticsMeasure = min;
        break;

      case MAX:
        statisticsMeasure = max;
        break;

      case MEAN:
        statisticsMeasure = mean;
        break;

      case MEDIAN:
        statisticsMeasure = median;
        break;

      case MODE:
        statisticsMeasure = mode;
        break;

      case PERCENTILE:
        statisticsMeasure = percentile;
        break;

      case SD:
        statisticsMeasure = sd;
        break;

      case LEFT_SD:
        statisticsMeasure = lsd;
        break;

      case RIGHT_SD:
        statisticsMeasure = rsd;
        break;

      case MAD:
        statisticsMeasure = mad;
        break;

      case LEFT_MAD:
        statisticsMeasure = lmad;
        break;

      case RIGHT_MAD:
        statisticsMeasure = rmad;
        break;

      case MoAD:
        statisticsMeasure = moad;
        break;

      case LEFT_MoAD:
        statisticsMeasure = lmoad;
        break;

      case RIGHT_MoAD:
        statisticsMeasure = rmoad;
        break;

      case SN:
        statisticsMeasure = sn;
        break;

      case LEFT_SN:
        statisticsMeasure = lsn;
        break;

      case RIGHT_SN:
        statisticsMeasure = rsn;
        break;

      case QN:
        statisticsMeasure = qn;
        break;

      case LEFT_QN:
        statisticsMeasure = lqn;
        break;

      case RIGHT_QN:
        statisticsMeasure = rqn;
        break;
    }
