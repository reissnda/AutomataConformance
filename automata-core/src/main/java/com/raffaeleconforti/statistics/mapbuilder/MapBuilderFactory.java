...
public class MapBuilderFactory {
  ...
  public static OutlierMapBuilder getOutlierMapBuilder(OutlierIdentifierGenerator<String> outlierIdentifierGenerator,
      int type, XEventClassifier xEventClassifier) {
