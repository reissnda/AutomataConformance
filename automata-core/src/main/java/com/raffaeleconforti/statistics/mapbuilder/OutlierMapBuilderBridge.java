...
public class OutlierMapBuilderBridge extends OutlierMapBuilderAbstract {
  ...
  private void build(XEvent event1, XEvent event2, XEvent event3, boolean smart) {
    OutlierIdentifier outlierIdentifier = outlierIdentifierGenerator
        .generate(getEventName(event1), getEventName(event3));
    ...
    OutlierIdentifier outlierIdentifier1 = outlierIdentifierGenerator
        .generate(getEventName(event1), getEventName(event2));
    Outlier<String> outlier1 = new Outlier<String>(getEventName(event1) + getEventName(event2), outlierIdentifier,
        false);
