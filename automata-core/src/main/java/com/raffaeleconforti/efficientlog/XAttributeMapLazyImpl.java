...
public class XAttributeMapLazyImpl<T extends XAttributeMap> implements XAttributeMap {
   ...
   */
  private static final Set<Entry<String, XAttribute>> EMPTY_ENTRYSET = Collections
      .unmodifiableSet(new UnifiedSet<Entry<String, XAttribute>>(0));

  /**
   * Default empty key set used for lazy operation.
   */
  private static final Set<String> EMPTY_KEYSET = Collections.unmodifiableSet(new UnifiedSet<String>(0));

  /**
   * Default empty entries used for lazy operation.
   */
  private static final Collection<XAttribute> EMPTY_ENTRIES = Collections
      .unmodifiableCollection(new ArrayList<XAttribute>(0));

  /**
   * Class implementing the backing store; this is needed for initialization
   * of generic classes, as of the Java language.
   */
  private final Class<T> backingStoreClass;
