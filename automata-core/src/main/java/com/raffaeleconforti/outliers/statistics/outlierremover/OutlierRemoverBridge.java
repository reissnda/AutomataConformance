...
public class OutlierRemoverBridge extends OutlierRemoverAbstract {
  ...
  public OutlierRemoverBridge(OutlierIdentifierGenerator outlierIdentifierGenerator,
  ...
  private void removeOutlierSelectOnlyOne(XTrace t, XTrace newT, int i) {
    ...
    if (!nameBefore.equals(((DoubleOutlierIdentifier) outlier.getIdentifier()).getIdentifier1()) || !nameAfter
        .equals(((DoubleOutlierIdentifier) outlier.getIdentifier()).getIdentifier2()) || !nameGuilty
