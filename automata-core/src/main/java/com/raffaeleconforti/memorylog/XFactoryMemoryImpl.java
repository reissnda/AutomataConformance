...
public class XFactoryMemoryImpl implements XFactory {
  ...
  private final IntObjectHashMap<XEvent> intToEvent = new IntObjectHashMap<>();

  private final ObjectIntHashMap<XEvent> eventToInt = new ObjectIntHashMap<>();
  ...
  public String getDescription() {
    return "Creates naive implementations for all available " + "model hierarchy elements, i.e., no optimizations "
        + "will be employed.";
  }
