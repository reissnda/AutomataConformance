...
public class AutomatonInfrequentBehaviourRemover {
  ...
  public static XLog removeInfrequentBehaviour(PluginContext context, XEventClassifier xEventClassifier, XLog log,
      Automaton<String> automaton, double lowerbound, double upperbound, double exception, boolean excludeTraces,
      boolean deviance) throws HighThresholdException {
  ...
  private static XLog filter(PluginContext context, XEventClassifier xEventClassifier, XLog log,
      Automaton<String> automaton, boolean excludeTraces, boolean deviance) {
    ...
    do {
      ...
      try {
        ...
        replayResults = replayer
            .replayLog(context, petrinet, log, constructMapping(petrinet, log, dummyEvClass, eventClassifier),
                parameters);
  ...
  private static Map<XEventClass, Integer> constructMOTCostFunction(XLog log, XEventClassifier eventClassifier,
