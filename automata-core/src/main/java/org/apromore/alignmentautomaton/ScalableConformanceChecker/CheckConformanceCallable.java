...
public class CheckConformanceCallable implements Callable<CheckConformanceCallable> {
  ...
  public CheckConformanceCallable(PSP psp, Automaton logAutomaton, Automaton modelAutomaton, IntArrayList trace,
      IntIntHashMap finalConfiguration, int stateLimit, boolean useVisited) {
    this.psp = psp;
  ...
  public void calculatePartiallySynchronizedPathWithLeastSkips() {
    ...
    result.getTraceIndex().
        ...
        addAll(Arrays.asList(relevantTraces));
