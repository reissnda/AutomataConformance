...
public class Synchronization {
  ...
  public Synchronization(int eventLog, int eventModel) {
    ...
    if (eventLog == perp) {
      ...
      operation = Configuration.Operation.MATCH;
    }
  }
  ...
  public Synchronization(Configuration.Operation operation, int eventLog, int eventModel, int targetLog,
      int targetModel, int sourceNode) {
    this.operation = operation;
  ...
  public boolean equals(Object o) {
    ...
    if (this.operation() != transition.operation()) {
      return false;
    }
    if (this.eventLog() != transition.eventLog()) {
      return false;
    }
    return this.eventModel() == transition.eventModel();
