...
package org.apromore.alignmentautomaton.ilpsolverwrapper;
...
public interface ILPSolver {
  ...
  ILPSolverVariable addVariable(double lowerBound, double upperBound, double objectiveCoefficient,
      VariableType variableType, String variableName);

  ILPSolverExpression createExpression();

  ILPSolverConstraint addConstraint(ILPSolverExpression expression, Operator operator, double coefficient,
