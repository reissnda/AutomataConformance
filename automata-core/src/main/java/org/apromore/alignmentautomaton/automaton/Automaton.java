package org.apromore.alignmentautomaton.automaton;
...
public class Automaton {
  ...
  public Automaton(Map<Integer, State> states, BiMap<Integer, String> labelMapping,
      BiMap<String, Integer> inverseLabelMapping, Map<Integer, Transition> transitions, int initialState,
      IntHashSet FinalStates, UnifiedMap<IntArrayList, IntArrayList> caseTracesMapping, Map<Integer, String> caseIDs) {
    this.states = states;
  ...
  public Automaton(Map<Integer, State> states, BiMap<Integer, String> labelMapping,
      ...
      UnifiedMap<IntIntHashMap, UnifiedSet<IntArrayList>> configReducedTraceMapping) {
    this.states = states;
    this.eventLabels = labelMapping;
    this.inverseEventLabels = inverseLabelMapping;
    this.transitions = transitions;
  ...
  public Automaton(Map<Integer, State> states, BiMap<Integer, String> eventLabels,
      BiMap<String, Integer> inverseLabelMapping, Map<Integer, Transition> transitions, int initialState,
      IntHashSet finalStates, int skipEvent) {
    this.states = states;
  ...
  public Automaton(BiMap<Integer, State> states, BiMap<Integer, String> eventLabels,
      BiMap<String, Integer> inverseEventLabelMapping, BiMap<Integer, Transition> transitions, int initialState,
      IntHashSet finalStates, int skipEvent, BiMap<Integer, String> globalEventLabels) {
    this.states = states;
    this.eventLabels = eventLabels;
  ...
  public IntHashSet getParallelLabels() {
    return this.parallelLabels;
  }

  public void setParallelLabels(IntHashSet parallelLabels) {
  ...
  private void discoverFinalConfigurationsForModel() throws FileNotFoundException//(boolean discoverPotentialPaths)
  {
    ...
    while (!toBeVisited.isEmpty()) {
      ...
      if (components[state.component()].size() > 1) {
        traverseSComponent(compInArcs.get(state.component()), compOutArcs.get(state.component()),
            compArcs.get(state.component()), state.possibleFutures(), cLoopLabels.get(state.component()),
            state.component());
      }
  ...
  private void traverseSComponent(List<Transition> compInArcs, List<Transition> compOutArcs, List<Transition> compArcs,
      Set<IntIntHashMap> baseFutures, IntIntHashMap cLoopLabels, int comp) {
		/*IntArrayList toBeVisited = new IntArrayList();
        IntHashSet visited = new IntHashSet();
        IntIntHashMap possibleFuture;
