...
public abstract class ReplayerParameters {
  ...
  private ReplayerParameters(Algorithm algorithm, boolean moveSort, boolean queueSort, boolean preferExact,
      int nThreads, boolean useInt, Debug debug, int timeoutMilliseconds, int maximumNumberOfStates, int costUpperBound,
  ...
  public final static class Default extends ReplayerParameters {
    ...
    public Default() {
      super(Algorithm.INCREMENTALASTAR, false, true, true, Math.max(1, Runtime.getRuntime().availableProcessors() / 4),
          false, Debug.NONE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, false, true, 0);
    }

    public Default(int nThreads, Debug debug) {
      super(Algorithm.INCREMENTALASTAR, false, true, true, nThreads, false, debug, Integer.MAX_VALUE, Integer.MAX_VALUE,
          Integer.MAX_VALUE, false, false, 0);
    }

    public Default(int nThreads, int costUpperBound, Debug debug) {
      super(Algorithm.INCREMENTALASTAR, false, true, true, nThreads, false, debug, Integer.MAX_VALUE, Integer.MAX_VALUE,
          costUpperBound, false, false, 0);
    }
  ...
  public final static class AStar extends ReplayerParameters {
    ...
    public AStar(boolean moveSort, boolean queueSort, boolean preferExact, int nThreads, boolean useInt, Debug debug,
        int timeoutMilliseconds, int maximumNumberOfStates, int costUpperBound, boolean partiallyOrderEvents) {
  ...
  public final static class IncementalAStar extends ReplayerParameters {
    ...
    public IncementalAStar() {
      super(Algorithm.INCREMENTALASTAR, false, true, true, Math.max(1, Runtime.getRuntime().availableProcessors() / 2),
          false, Debug.NONE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, false, false, 0);
    }

    public IncementalAStar(Debug debug) {
      super(Algorithm.INCREMENTALASTAR, false, true, true, Math.max(1, Runtime.getRuntime().availableProcessors() / 2),
          false, debug, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, false, false, 0);
    }
    ...
    public IncementalAStar(boolean moveSort, int nThreads, boolean useInt, Debug debug, int timeoutMilliseconds,
      ...
      super(Algorithm.INCREMENTALASTAR, moveSort, true, true, nThreads, useInt, debug, timeoutMilliseconds,
          maximumNumberOfStates, costUpperBound, partiallyOrderEvents, preProcessUsingPlaceBasedConstraints, 0);
    }
