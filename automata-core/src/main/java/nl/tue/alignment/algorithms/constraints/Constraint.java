...
public class Constraint {
  ...
  public int hashCode() {
    return threshold + 31 * Arrays.hashCode(inputLabelOccurrence) + 31 * 31 * Arrays.hashCode(outputLabelOccurrence);
  }

  public boolean equals(Object o) {
    if (o instanceof Constraint) {
      Constraint c = (Constraint) o;
      return threshold == c.threshold && Arrays.equals(inputLabelOccurrence, c.inputLabelOccurrence) && Arrays
          .equals(outputLabelOccurrence, c.outputLabelOccurrence);
    }
    return false;
  }
