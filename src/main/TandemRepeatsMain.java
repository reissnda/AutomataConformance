...
import org.processmining.plugins.signaturediscovery.encoding.*;
...
public class TandemRepeatsMain
{
    ...
    private static void computeRepeatfeatureFeatureSetMap(int encodingLength, String charStream, Set<Feature> repeatFeatureSet){
