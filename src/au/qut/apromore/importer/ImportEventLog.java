...
public class ImportEventLog {
	...
	public Automaton createReducedDAFSAfromLog(XLog xLog, BiMap<String,Integer> inverseLabelMapping) throws IOException
	{
	...
	public Automaton createOriginalDAFSAafterReduction() throws IOException
	{
