...
package com.raffaeleconforti.java.util;
...
//        factory = new XFactoryMemoryImpl();
    ...
    private Object getAttributeValue(XAttribute attribute) {
        ...
        else if(attribute instanceof XAttributeID) return ((XAttributeID) attribute).getValue();
        else {
    ...
    private XAttribute createXAttribute(String key, Object value, XAttribute originalAttribute) {
        ...
        else if(originalAttribute instanceof XAttributeID) result = factory.createAttributeID(key, (XID) value, null);
        else {
